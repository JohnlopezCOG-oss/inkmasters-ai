...
export default function MessageBubble({ message }: MessageBubbleProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`max-w-[88%] rounded-2xl px-4 py-2.5 text-[15px] leading-relaxed sm:max-w-[72%] ${
          isUser
            ...
            : "rounded-bl-md bg-zinc-800/80 text-zinc-100"
        }`}
      >
        {!isUser && (
          <p className="mb-0.5 text-[11px] font-semibold uppercase tracking-wider text-orange-400/80">
      ...
      {/* User avatar */}
      {isUser && (
        <div className="mb-1 hidden h-7 w-7 shrink-0 items-center justify-center rounded-full bg-zinc-700 sm:flex">
          <svg
